...
ANALISIS_PROMPT = HumanMessagePromptTemplate.from_template(
    ...
    Proporciona un análisis detallado, objetivo y profesional. El CV puede venir en ingles, pero manten la evaluacion en español
    ...
    **INSTRUCCIONES ESPECÍFICAS:**
    ...
    6. Asigna un porcentaje de ajuste realista (0-100) considerando:
        - Experiencia relevante (35% del peso)
